...
//const unsigned char DESKEY[8]={0x58,0x8A,0x31,0x44,0x14,0x2C,0x8F,0x2D,}; //加密密钥0(主机的解密密钥)
...
/************************************************************************/
static void transpose(uint8_t *idata, uint8_t *odata, const uint8_t *tbl, uint8_t n)
{
...
static void rotate_l(uint8_t *key)
{
  uint8_t str_x[8];
  uint8_t i;
...
/*                              main_key[8]                             */
/************************************************************************/
static void compute_subkeys(uint8_t *key)
{
...
/************************************************************************/
static void f(uint8_t *skey, uint8_t *a_str, uint8_t *x_str)
{
