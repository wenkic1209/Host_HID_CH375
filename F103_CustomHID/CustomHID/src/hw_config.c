...
{
   LCD_UsrLog("WKUP_Callback");
}
void CTR_Callback(void)
{
   LCD_UsrLog("CTR_Callback");
}
void RESET_Callback(void)
{
   LCD_UsrLog("RESET_Callback");
}
void SUSP_Callback(void)
{
   LCD_UsrLog("SUSP_Callback");
}
void SOF_Callback(void)
{
   LCD_UsrLog("SOF_Callback");
}
void ESOF_Callback(void)
{
   LCD_UsrLog("ESOF_Callback");
}
/*******************************************************************************
...
//#endif /* STM32L1XX_XD */ 
//  RCC_APB2PeriphClockCmd( RCC_APB2Periph_GPIO_IOAIN , ENABLE);   
